      ...
      <main className="container mx-auto px-4 py-3 space-y-1">
        ...
        <div className="mt-1 grid gap-1 grid-cols-2">
          <Dialog open={driverDialogOpen} onOpenChange={setDriverDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Driver Name & ID</DialogTitle>
              </DialogHeader>
              <div className="space-y-4 mt-4">
                <div className="space-y-2">
                  <Label htmlFor="driver-name">Name</Label>
                  <Input id="driver-name" type="text" placeholder="Enter driver name" value={driverNameInput} onChange={e => setDriverNameInput(e.target.value)} onKeyPress={e => e.key === "Enter" && handleSaveDriver()} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="driver-id">ID</Label>
                  <Input id="driver-id" type="text" placeholder="Enter driver ID" value={driverIdInput} onChange={e => setDriverIdInput(e.target.value)} onKeyPress={e => e.key === "Enter" && handleSaveDriver()} />
                </div>
